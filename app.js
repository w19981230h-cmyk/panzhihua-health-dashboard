...
// 公卫任务清单与全部患者共用同一份患者基础信息。
window.patientBaseRows=baseRows;
...
const dashboardDrilldownData={
  ...
  medicalGroup:{
    全市:['全部医疗集团','攀枝花市紧密型城市医疗集团','攀枝花学院附属医院医联体'],
    东区:['全部医疗集团','攀枝花市紧密型城市医疗集团','攀枝花学院附属医院医联体'],
    西区:['全部医疗集团','攀枝花市紧密型城市医疗集团'],
    仁和区:['全部医疗集团','攀枝花市紧密型城市医疗集团'],
    米易县:['全部医疗集团','攀枝花市县域医疗共同体'],
    盐边县:['全部医疗集团','攀枝花市县域医疗共同体']
  },
  organization:{
    全部医疗集团:['全部机构','攀枝花市中心医院','攀枝花市中西医结合医院','攀枝花学院附属医院','仁和区人民医院'],
    攀枝花市紧密型城市医疗集团:['全部机构','攀枝花市中心医院','攀枝花市中西医结合医院','仁和区人民医院'],
    攀枝花学院附属医院医联体:['全部机构','攀枝花学院附属医院','攀枝花市第二人民医院'],
    攀枝花市县域医疗共同体:['全部机构','米易县人民医院','盐边县人民医院']
  },
  team:{
    全部机构:['全部团队','心血管慢病管理团队','糖尿病管理团队','呼吸慢病管理团队','家庭医生管理团队'],
    攀枝花市中心医院:['全部团队','心血管慢病管理团队','糖尿病管理团队','呼吸慢病管理团队'],
    攀枝花市中西医结合医院:['全部团队','中西医慢病联合管理团队','健康管理团队'],
    攀枝花学院附属医院:['全部团队','高血压管理团队','糖尿病管理团队'],
    攀枝花市第二人民医院:['全部团队','老年慢病管理团队'],
    仁和区人民医院:['全部团队','家庭医生管理团队'],
    米易县人民医院:['全部团队','县域慢病管理团队'],
    盐边县人民医院:['全部团队','县域慢病管理团队']
  },
  person:{
    全部团队:['全部','张医生','李医生','王医生','刘医生'],
    心血管慢病管理团队:['全部','张医生','王医生'],
    糖尿病管理团队:['全部','李医生','刘医生'],
    呼吸慢病管理团队:['全部','陈医生','赵医生'],
    中西医慢病联合管理团队:['全部','周医生','何医生'],
    健康管理团队:['全部','孙医生','杨医生'],
    高血压管理团队:['全部','张医生','陈医生'],
    老年慢病管理团队:['全部','何医生','周医生'],
    家庭医生管理团队:['全部','刘医生','赵医生'],
  ...
  root.innerHTML=`
    ...
    <div class="dash-canvas">
      <div class="dash-filter-row">
        ...
        ${buildDashboardSelect('全部医疗集团',dashboardDrilldownData.medicalGroup['全市'],'medicalGroup')}
        ${buildDashboardSelect('全部机构',dashboardDrilldownData.organization['全部医疗集团'],'organization')}
        ${buildDashboardSelect('全部团队',dashboardDrilldownData.team['全部机构'],'team')}
        ${buildDashboardSelect('全部',dashboardDrilldownData.person['全部团队'],'person')}
      </div>
